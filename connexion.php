    ...
    <div class="login-form">
        ...
        <div class="form_groupe">
            <form action="" method="POST">
                ...
                <div class="form_groupe">
                    <label for="nom">Nom
                        <input id="nom" type="text" name="nom" class="form1" required="required" autocomplete="off" minlength="2" maxlength="40">
                    </label>
                </div>
                <div class="form_groupe">
                    <label for="prenom">Prenom
                        <input id="prenom" type="text" name="prenom" class="form1" name="nom" required="required" autocomplete="off" minlength="2" maxlength="50">
                    </label>
                </div>
                <div class="form_groupe">
                    <label for="password">Mot de passe
                        <input id="password" type="password" name="password" class="form1" required="required" autocomplete="off" minlength="2" maxlength="25">
                    </label>
                </div>
                <div class="form_groupe">
                    <label for="email">Email
                        <input id="email" type="email" name="email" class="form1" required="required" autocomplete="off" minlength="2" maxlength="80">
                    </label>
                </div>
